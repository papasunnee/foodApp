         ...
         <div class="form-group">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="number" min="0" required name="price" class="form-control" id="price" placeholder="Price" value="${f.price}">
            </div>
        </div>
        <div class="form-group">
          <label for="description">Food Item Description</label>
          <input type="text" name="description" class="form-control" id="description" placeholder="Description" ${f.description}>
        </div>
